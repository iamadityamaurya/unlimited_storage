...
export const FolderIcon = () => (
  <svg 
    className="w-20 h-20 drop-shadow-xl transition-transform duration-300" 
    viewBox="0 0 48 48" 
    fill="none" 
...
export const GenericFileIcon = () => (
  <svg className="w-20 h-20 drop-shadow-xl transition-transform duration-300 opacity-80 group-hover:opacity-100" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
